...
`ConsistentHistories.Foundation.LocatedSemilattices`.
-/

namespace ConsistentHistories.Models.Introduction
...
`ConsistentHistories.Models.LocatedSemilattices.Examples`.
-/
...
end ConsistentHistories.Models.Introduction
