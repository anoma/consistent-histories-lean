import ContForm.Routes.PathProperties.Compatibility
...
namespace ContForm.Routes.PathProperties.MainResult
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent cd
      ...
      (by
        ...
        exact
          ContForm.Routes.PathProperties.Compatibility.right_consistent_inconsistent_implies_active_inconsistent
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent_indexed cd
      ...
      (by
        intro j hcompat hinconsistent
        exact
          ContForm.Routes.PathProperties.Compatibility.right_consistent_inconsistent_implies_active_inconsistent_indexed
            cd hcompat hinconsistent)
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent cd
      (by
        intro j hincompat
        exact
          ContForm.Routes.PathProperties.Compatibility.rightIncompatible_exists_activeInconsistent_of_ordered_incompatible_branches
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent_indexed cd
      (by
        intro j hincompat
        exact
          ContForm.Routes.PathProperties.Compatibility.rightIncompatible_exists_activeInconsistent_of_ordered_incompatible_branches_indexed
            cd hincompat hdirectSameCenterBranch hswapSameCenterBranch)
      hrightConsistent
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent cd hrightIncompatible
      (by
        ...
        exact
          ContForm.Routes.PathProperties.Compatibility.right_consistent_inconsistent_of_inactive_least_preCircuit_center_contradiction
            cd hcompat hinconsistent
            (by
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent cd hrightIncompatible
      (by
        intro bound hcompat hinconsistent
        exact
          ContForm.Routes.PathProperties.Compatibility.right_consistent_inconsistent_of_inactive_least_cutPrefix_center_contradiction
            cd hcompat hinconsistent
            (by
              intro least hleast hinactive
  ...
  exact
    index_result_of_right_incompatible_and_right_consistent cd hrightIncompatible
      (by
        intro bound hcompat hinconsistent
        exact
          ContForm.Routes.PathProperties.Compatibility.right_consistent_inconsistent_of_inactive_least_witnesses_before_cut_bases
            cd hcompat hinconsistent
            (by
              intro least hleast hinactive
...
theorem inconsistentIndex_implies_activeInconsistentIndex {Time : Type v} {Ctrl : Type u} [LocatedSemilatticeWithCut Time Ctrl]
  ...
  exact
    index_result_of_right_incompatible cd
      (ContForm.Routes.PathProperties.Compatibility.rightIncompatiblePair_implies_activeInconsistent
        cd)
...
end ContForm.Routes.PathProperties.MainResult
