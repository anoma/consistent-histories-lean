import ContForm.Routes.StrongerSafety.Chains
import ContForm.Models.Cut.InductiveConstructionLaws
...
namespace ContForm.Routes.StrongerSafety.Absolute
...
open ContForm.Models.Cut.InductiveConstruction
open ContForm.Routes.StrongerSafety.Chains
open ContForm.Routes.StrongerSafety.Closure
...
theorem cutPrefixData_postCut_initialPrefix_next_base_of_adjacent
  ...
  have hactiveLower : firstCut.Active firstData.idxI := by
    simpa [firstCut] using
      ContForm.Routes.PathProperties.InactiveCuts.cutPrefixData_final_cut_lower_active
        firstData
  have hidx :
  ...
  exact
    ContForm.Routes.PathProperties.InactiveCuts.cutPrefixData_active_prefix_before_base
...
theorem cClosure_inconsistent_of_ordered_incompatible_branches_and_right_consistent_and_one_sided_branches
  ...
  exact
    cClosure_inconsistent_of_one_sided_branches cd
      (ContForm.Routes.PathProperties.MainResult.inconsistent_activeInconsistent_of_ordered_incompatible_branches_and_right_consistent
...
theorem cClosure_inconsistent_of_least_one_sided_branches
  ...
  have hleastResult :
    ...
    ContForm.Routes.PathProperties.MainResult.least_inconsistent_activeInconsistent_of_index_result
      cd hleast hindex
...
theorem cClosure_inconsistent_of_right_incompatible_and_right_consistent_and_least_chain_branches
  ...
  exact cClosure_inconsistent_of_least_chain_branches cd
    (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible_and_right_consistent
...
theorem cClosure_inconsistent_of_right_incompatible_and_least_chain_branches
  ...
  exact
    cClosure_inconsistent_of_least_chain_branches cd
      (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible
...
theorem cClosure_inconsistent_of_ordered_incompatible_branches_and_right_consistent_and_least_chain_branches
    ...
    cd.Inconsistent →
      TimesInconsistent
        (CClosure (ActiveCtrlCircuit cd) (ActiveTimeCircuit cd)) := by
  exact cClosure_inconsistent_of_least_chain_branches cd
    (ContForm.Routes.PathProperties.MainResult.index_result_of_ordered_incompatible_branches_and_right_consistent
      cd hdirectSameCenterBranch hswapSameCenterBranch hrightConsistent)
    hleftNoContr hleftEdges hrightNoContr hrightEdges
...
theorem cClosure_inconsistent_of_right_incompatible_and_preCircuit_center_contradiction_and_least_chain_branches
    ...
    cd.Inconsistent →
      TimesInconsistent
        (CClosure (ActiveCtrlCircuit cd) (ActiveTimeCircuit cd)) := by
  exact cClosure_inconsistent_of_least_chain_branches cd
    (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible_and_preCircuit_center_contradiction
...
theorem cClosure_inconsistent_of_right_incompatible_and_cutPrefix_center_contradiction_and_least_chain_branches
    ...
    cd.Inconsistent →
      TimesInconsistent
        (CClosure (ActiveCtrlCircuit cd) (ActiveTimeCircuit cd)) := by
  exact cClosure_inconsistent_of_least_chain_branches cd
    (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible_and_cutPrefix_center_contradiction
...
theorem cClosure_inconsistent_of_right_incompatible_and_witnesses_before_cut_bases_and_least_chain_branches
    ...
    cd.Inconsistent →
      TimesInconsistent
        (CClosure (ActiveCtrlCircuit cd) (ActiveTimeCircuit cd)) := by
  exact cClosure_inconsistent_of_least_chain_branches cd
    (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible_and_witnesses_before_cut_bases
...
theorem cClosure_inconsistent_of_right_incompatible_and_chain_links_indexed
  ...
  exact
    cClosure_inconsistent_of_least_chain_links_indexed_closed cd
      (ContForm.Routes.PathProperties.MainResult.index_result_of_right_incompatible_indexed
        cd hrightIncompatible)
...
theorem cClosure_inconsistent_of_ordered_incompatible_branches_and_chain_links_indexed :
  ...
  exact
    cClosure_inconsistent_of_least_chain_links_indexed_closed cd
      (ContForm.Routes.PathProperties.MainResult.index_result_of_ordered_incompatible_branches_indexed
...
theorem inconsistentCircuit_implies_cClosure_inconsistent {Time : Type v} {Ctrl : Type u} [LocatedSemilatticeWithCut Time Ctrl]
  ...
  exact
    cClosure_inconsistent_of_least_chain_links_closed cd
      (ContForm.Routes.PathProperties.MainResult.inconsistentIndex_implies_activeInconsistentIndex
        cd)
...
end ContForm.Routes.StrongerSafety.Absolute
